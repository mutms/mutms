...
if (!$filedata) {
    $form = new \tool_mucertify\local\form\source_manual_upload_file(null, ['certification' => $certification, 'source' => $source, 'context' => $context]);
} else {
    $form = new \tool_mucertify\local\form\source_manual_upload_options(null, ['certification' => $certification,
...
if ($data = $form->get_data()) {
    if ($filedata && $form instanceof \tool_mucertify\local\form\source_manual_upload_options) {
