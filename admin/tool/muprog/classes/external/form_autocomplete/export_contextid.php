...
/**
 * Program export contextid autocompletion.
 *
 * @package     tool_muprog
 * @copyright   2025 Petr Skoda
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class export_contextid extends \tool_mulib\external\form_autocomplete\categorycontext {
    /**
     * Returns required capability.
     * @return string
     */
    public static function get_required_capability(): string {
        return 'tool/muprog:export';
    }
}
