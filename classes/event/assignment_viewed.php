...
/**
 * User assignment viewed event.
 *
 * @package    tool_mucertify
 * @copyright  2026 Petr Skoda
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class assignment_viewed extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' assignment in certification with id '$this->objectid' was viewed";
    }
    ...
    public static function get_name() {
        return get_string('event_assignment_viewed', 'tool_mucertify');
    }
    ...
    public function get_url() {
        return new \core\url('/admin/tool/mucertify/my/certification.php', ['id' => $this->other['certificationid'], 'userid' => $this->relateduserid]);
    }
