...
/**
 * Required credits not reached any more event.
 *
 * @package    tool_mutrain
 * @copyright  2025 Petr Skoda
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class required_credits_unreached extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' does not have required credits in framework '{$this->other['frameworkid']} any more'";
    }
    ...
    public static function get_name() {
        return get_string('event_required_credits_unreached', 'tool_mutrain');
    }
