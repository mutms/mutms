...
/**
 * Interactive book chapter created event.
 *
 * @package    mod_mubook
 * @copyright  2025 Petr Skoda
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class chapter_created extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the chapter with id '$this->objectid'";
    }

    #[\Override]
    public static function get_name() {
        return get_string('event_chapter_created', 'mod_mubook');
    }
