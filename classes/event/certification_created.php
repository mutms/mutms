 ...
 */
final class certification_created extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' created certification with id '$this->objectid'";
    }
    ...
    public static function get_name() {
        return get_string('event_certification_created', 'tool_mucertify');
    }
