...
final class source_manual_allocate_users extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            ], 'Array of date overrides can be passed as unix timestamps', VALUE_DEFAULT, []),
        ]);
    }
     ...
     * @param array|null $userids Users list to whom the program should be allocated.
     * @param array|null $cohortids Cohort list to whom the program should be allocated.
     * @param array $dateoverrides Date overrides.
     * @return array
     */
    public static function execute(int $programid, ?array $userids = null, ?array $cohortids = null, array $dateoverrides = []): array {
        global $DB;
        [
            'programid' => $programid,
            'userids' => $userids,
    ...
    public static function execute_returns(): external_multiple_structure {
        return new external_multiple_structure(
            new external_value(PARAM_INT, 'User id'),
            'List of users who were allocated'
        );
    }
}
