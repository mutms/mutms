...
namespace tool_muhome\external\form_autocomplete;
...
/**
 * Page add/update visible to cohortids autocompletion.
 *
 * @package     tool_muhome
 * @copyright   2025 Petr Skoda
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class page_cohortvisible extends \tool_mulib\external\form_autocomplete\cohort {
    #[\Override]
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'pageid' => new external_value(PARAM_INT, 'Page id', VALUE_REQUIRED),
     ...
     * @param int $pageid 0 is allowed
     * @param int $contextid ignored if pageid provided (unfortunately this does not match modified context selection)
     * @return array
     */
    public static function execute(string $query, int $pageid, int $contextid): array {
        global $DB, $USER;
