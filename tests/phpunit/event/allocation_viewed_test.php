...
/**
 * User allocation viewed event test.
 *
 * @group      MuTMS
 * @package    tool_muprog
 ...
 *
 * @covers \tool_muprog\event\allocation_viewed
 */
final class allocation_viewed_test extends \advanced_testcase {
    ...
    public function test_event(): void {
        ...
        $this->assertInstanceOf('tool_muprog\event\allocation_viewed', $events[0]);
        $event = $events[0];
        ...
        $this->assertSame('Program allocation viewed', $event::get_name());
        $description = $event->get_description();
        $programurl = new \core\url('/admin/tool/muprog/my/program.php', ['id' => $allocation->programid, 'userid' => $allocation->userid]);
