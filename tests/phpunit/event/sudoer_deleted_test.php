...
use tool_musudo\event\sudoer_deleted;
use tool_musudo\local\sudoer;

/**
 * Sudoer deleted event test.
 *
 * @group      MuTMS
 * @package    tool_musudo
 ...
 *
 * @covers \tool_musudo\event\sudoer_deleted
 */
final class sudoer_deleted_test extends \advanced_testcase {
    ...
    public function test_event(): void {
        ...
        $this->assertInstanceOf(sudoer_deleted::class, $event);
        ...
        $this->assertSame('Privileged user removed', $event::get_name());
