 ...
 *
 * @covers \tool_mutrain\event\required_credits_unreached
 */
final class required_credits_unreached_test extends \advanced_testcase {
    ...
    public function test_event(): void {
        ...
        $this->assertInstanceOf(\tool_mutrain\event\required_credits_unreached::class, $event);
        ...
        $this->assertSame('User does not have required credits any more', $event::get_name());
