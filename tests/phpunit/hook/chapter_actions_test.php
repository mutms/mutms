...
use mod_mubook\hook\chapter_actions;

/**
 * Chapter actions hook test.
 *
 * @package    mod_mubook
 * @copyright  2025 Petr Skoda
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 *
 * @covers \mod_mubook\hook\chapter_actions;
 */
final class chapter_actions_test extends \advanced_testcase {
    ...
    public function test_hook(): void {
        ...
        $manager->phpunit_redirect_hook(chapter_actions::class, $callback);
