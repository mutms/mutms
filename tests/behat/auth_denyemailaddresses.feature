...
Feature: Tenant authentication setting denyemailaddresses
  Background:
    ...
    And the following config values are set as admin:
      | registerauth        | email           |
      | passwordpolicy      | 0               |
      | denyemailaddresses  | zzz.example.com |
    And I log in as "admin"
    And I am on the "TEN2" "tool_mutenancy > Tenant authentication" page
    And I should see "Default value (zzz.example.com)" in the "Denied email domains" definition list item
    And I press "Update authentication"
    And I set the following fields to these values:
      | denyemailaddresses_override   | 1                   |
      | denyemailaddresses            | yyy.example.com     |
    And I click on "Update" "button" in the ".modal-dialog" "css_element"
    And I should see "yyy.example.com" in the "Denied email domains" definition list item
  ...
  Scenario: Users may not self register with email from denyemailaddresses overridden for tenant
    ...
    Then I should see "Email addresses in these domains are not allowed (zzz.example.com)"
    And I set the following fields to these values:
      | Email address | siteuser0@aaa.example.com |
      | Email (again) | siteuser0@aaa.example.com |
    And I press "Create my new account"
    And I should see "An email should have been sent to your address at siteuser0@aaa.example.com"
    And I should see "Acceptance test site"
    ...
    Then I should see "Email addresses in these domains are not allowed (zzz.example.com)"
    And I set the following fields to these values:
      | Email address | tenantuser1@aaa.example.com |
      | Email (again) | tenantuser1@aaa.example.com |
    And I press "Create my new account"
    And I should see "An email should have been sent to your address at tenantuser1@aaa.example.com"
    And I should see "Tent Site full 1"
    ...
    And I set the following fields to these values:
      ...
      | Last name     | tenantuser                  |
    And I press "Create my new account"
    Then I should see "Email addresses in these domains are not allowed (yyy.example.com)"
    And I set the following fields to these values:
      | Email address | tenantuser2@zzz.example.com |
      | Email (again) | tenantuser2@zzz.example.com |
    And I press "Create my new account"
    And I should see "An email should have been sent to your address at tenantuser2@zzz.example.com"
    And I should see "Tent Site full 2"
  ...
  Scenario: Users may not change email to value from denyemailaddresses overridden for tenant
    ...
    Then I should see "Email addresses in these domains are not allowed (zzz.example.com)"
    And I set the following fields to these values:
      | Email address | student0@yyy.example.com |
    And I press "Update profile"
    And I should see "from student0@example.com to student0@yyy.example.com"
    And I press "Continue"
    And I confirm changed email for "student0"
    And I should see "was successfully updated to student0@yyy.example.com"
    ...
    Then I should see "Email addresses in these domains are not allowed (zzz.example.com)"
    And I set the following fields to these values:
      | Email address | student1@yyy.example.com |
    And I press "Update profile"
    And I should see "from student1@example.com to student1@yyy.example.com"
    And I press "Continue"
    And I confirm changed email for "student1"
    And I should see "was successfully updated to student1@yyy.example.com"
    ...
    And I press "Update profile"
    And I should see "from student2@example.com to student2@zzz.example.com"
    And I press "Continue"
    And I confirm changed email for "student2"
    And I should see "was successfully updated to student2@zzz.example.com"
