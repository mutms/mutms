...
/**
 * Interactive book chapter content deleted event.
 *
 * @package    mod_mubook
 * @copyright  2025 Petr Skoda
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class content_deleted extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted content with id '$this->objectid'";
    }

    #[\Override]
    public static function get_name() {
        return get_string('event_content_deleted', 'mod_mubook');
    }
