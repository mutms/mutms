...
use mod_mubook\event\course_module_viewed;
 ...
 *
 * @covers \mod_mubook\event\course_module_viewed;
 */
final class course_module_viewed_test extends \advanced_testcase {
    ...
    public function test_event(): void {
        ...
        course_module_viewed::create_from_mubook($mubook, $context)->trigger();
        $events = $sink->get_events();
        $sink->close();

        $this->assertCount(1, $events);
        $this->assertInstanceOf(course_module_viewed::class, $events[0]);
        ...
        $this->assertSame('Course module viewed', $event::get_name());
