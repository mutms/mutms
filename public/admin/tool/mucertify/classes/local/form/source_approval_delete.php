 ...
 */
final class source_approval_delete extends \tool_mulib\local\ajax_form {
    #[\Override]
    protected function definition() {
        ...
        $this->add_action_buttons(true, get_string('source_approval_requestdelete', 'tool_mucertify'));
    }
