...
/**
 * User assignment archived event.
 *
 * @package    tool_mucertify
 * @copyright  2025 Petr Skoda
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class assignment_archived extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' assignment in certification with id '$this->objectid' was archived";
    }
    ...
    public static function get_name() {
        return get_string('event_assignment_archived', 'tool_mucertify');
    }
    ...
    public function get_url() {
        return new \core\url('/admin/tool/mucertify/management/assignment.php', ['id' => $this->objectid]);
    }
