...
/**
 * User allocation archived event.
 *
 * @package    tool_muprog
 * @copyright  2025 Petr Skoda
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class allocation_archived extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The allocation of user with id '$this->relateduserid' to program with id '$this->objectid' was archived";
    }
    ...
    public static function get_name() {
        return get_string('event_allocation_archived', 'tool_muprog');
    }
