...
/**
 * Tenant auth updated event.
 *
 * @package     tool_mutenancy
 * @copyright   2025 Petr Skoda
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class auth_updated extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated authentication of tenant with id '$this->objectid'";
    }
    ...
    public static function get_name() {
        return get_string('event_auth_updated', 'tool_mutenancy');
    }
    ...
    public function get_url() {
        return new \moodle_url('/admin/tool/mutenancy/tenant_auth.php', ['id' => $this->objectid]);
    }
