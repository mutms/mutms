...
/**
 * Tenant restored event.
 *
 * @package     tool_mutenancy
 * @copyright   2025 Petr Skoda
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class tenant_restored extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' restored tenant with id '$this->objectid'";
    }
    ...
    public static function get_name() {
        return get_string('event_tenant_restored', 'tool_mutenancy');
    }
