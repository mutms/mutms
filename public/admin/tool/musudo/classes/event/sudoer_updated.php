...
/**
 * Sudoer updated event.
 *
 * @package    tool_musudo
 * @copyright  2025 Petr Skoda
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class sudoer_updated extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated privileged user with id '$this->relateduserid'";
    }
    ...
    public static function get_name() {
        return get_string('event_sudoer_updated', 'tool_musudo');
    }
