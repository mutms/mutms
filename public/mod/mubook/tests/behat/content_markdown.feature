...
Feature: Editors may manage Markdown content in mod_mubook
  ...
  Scenario: Editing teachers may edit Markdown content in chapters of Interactive books
  ...
  Scenario: Students may be allowed to edit Markdown content in Interactive book
