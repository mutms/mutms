...
use mod_mubook\event\content_deleted;

/**
 * Chapter content deleted event test.
 *
 * @package    mod_mubook
 * @copyright  2025 Petr Skoda
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 *
 * @covers \mod_mubook\event\content_deleted;
 */
final class content_deleted_test extends \advanced_testcase {
    ...
    public function test_event(): void {
        ...
        $this->assertInstanceOf(content_deleted::class, $events[0]);
        ...
        $this->assertSame('Content deleted', $event::get_name());
