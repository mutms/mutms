...
use mod_mubook\event\chapter_updated;

/**
 * Chapter updated event test.
 *
 * @package    mod_mubook
 * @copyright  2025 Petr Skoda
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 *
 * @covers \mod_mubook\event\chapter_updated;
 */
final class chapter_updated_test extends \advanced_testcase {
    ...
    public function test_event(): void {
        ...
        $chapter = $chapter::update((object)['id' => $chapter->id, 'title' => 'test']);
        $events = $sink->get_events();
        $sink->close();

        $this->assertCount(1, $events);
        $this->assertInstanceOf(chapter_updated::class, $events[0]);
        ...
        $this->assertSame('Chapter updated', $event::get_name());
