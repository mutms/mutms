...
$currenturl = new moodle_url('/admin/tool/mucertify/management/certification_archive.php', ['id' => $certification->id]);
$PAGE->set_context($context);
$PAGE->set_url($currenturl);

$form = new \tool_mucertify\local\form\certification_archive(null, ['certification' => $certification]);
...
if ($data = $form->get_data()) {
    certification::archive($certification->id);
